from modules.presets import MOONSHOT_CHAT_COMPLETION_URL, CHAT_COMPLETION_URL, BALANCE_API_URL, USAGE_API_URL, API_HOST, OPENAI_API_BASE, IMAGES_COMPLETION_URL
import os
import queue
import openai
...
class State:
    ...
    moonshot_chat_completion_url = MOONSHOT_CHAT_COMPLETION_URL
